...
public class EMDRPreScroll_ProblemDetail : MonoBehaviour {
    ...
    IEnumerator UpdateUI_Coroutine()
    {
        ...
        string[] problemdetails = ed.User.GetProblemDetails();
